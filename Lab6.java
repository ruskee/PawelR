...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
		...
		gl2.glMaterialfv(GL2.GL_FRONT,GL_AMBIENT_AND_DIFFUSE,new float[]{1,0.7f,0.9f,2},1);
        Pyramid(gl2,10);
	...
	public void init(GLAutoDrawable drawable) {
        ...
        kolor();
        gl2.glLightfv(GL_LIGHT0, GL_SPECULAR,new float[]{r,g,b,1},0);
        kolor();
        gl2.glLightfv(GL_LIGHT1, GL_DIFFUSE, new float[]{r,g,b,0},0);
        kolor();
        gl2.glLightfv(GL_LIGHT2, GL_DIFFUSE, new float[]{r,g,b,0},0);      
	}
